...
export const addProblemToPlaylist = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, "Problem added to playlist successfully", {
...
export const createPlaylist = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, "Playlist created successfully", {
        data: playlist,
    }));
});
...
export const removeProblemFromPlaylist = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, "Problem removed from playlist successfully", {
        data: problemInPlaylist,
    }));
});
...
//# sourceMappingURL=Playlist.controllers.js.map