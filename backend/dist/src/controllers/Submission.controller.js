...
export const getAllSubmissions = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Submissions fetched successfully", {
        data: submissions,
    }));
});
...
export const getAllSubmissionCount = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "Submission count fetched successfully", {
...
export const getAllSubmissionStats = asyncHandler(async (req, res) => {
    ...
    const mostUsedLanguage = Object.entries(stats.byLanguage).sort((a, b) => b[1] - a[1])[0]?.[0] ??
        "N/A";
    ...
    return res.status(200).json(new ApiResponse(200, "User submission stats fetched successfully", {
        data: dashboardStats,
    }));
});
export const getSubmissionHeatMap = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, "User submission heatmap data fetched successfully", {
        data: formatted,
    }));
});
